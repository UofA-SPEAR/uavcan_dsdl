...
//
// Source File:
// /home/david/Documents/Clubs/SPEAR/uavcan_dsdl/public_regulated_data_types/uavcan/node/ID.1.0.uavcan
//
// Template:
// StructureType.j2
//
// Generated at:  2020-08-21 01:54:40.403020 UTC
// Is deprecated: no
// Fixed port ID: None
// Full name:     uavcan.node.ID
// Version:       1.0

#ifndef UAVCAN_NODE_ID_INCLUDED
#define UAVCAN_NODE_ID_INCLUDED
...
static inline NunavutSignedBitLength uavcan_node_ID_1_0_serialize(const uavcan_node_ID_1_0* in_instance, NunavutUnsignedBitLength offset, uint8_t* const out_buffer)
{
...
static inline NunavutSignedBitLength uavcan_node_ID_1_0_deserialize(uavcan_node_ID_1_0* const out_instance, NunavutUnsignedBitLength offset, uint8_t* const in_buffer, const size_t buf_size_bytes)
{
    NunavutSignedBitLength rc = 0;
