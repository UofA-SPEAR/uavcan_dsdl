...
//
// Source File:
// /home/david/Documents/Clubs/SPEAR/uavcan_dsdl/public_regulated_data_types/uavcan/si/sample/voltage/Scalar.1.0.uavcan
//
// Template:
// StructureType.j2
//
// Generated at:  2020-08-21 01:54:48.271636 UTC
// Is deprecated: no
// Fixed port ID: None
// Full name:     uavcan.si.sample.voltage.Scalar
// Version:       1.0

#ifndef UAVCAN_SI_SAMPLE_VOLTAGE_SCALAR_INCLUDED
#define UAVCAN_SI_SAMPLE_VOLTAGE_SCALAR_INCLUDED
...
/// Initialize an uavcan_si_sample_voltage_Scalar_1_0 instance to default values.
...
static inline void uavcan_si_sample_voltage_Scalar_1_0_init(uavcan_si_sample_voltage_Scalar_1_0* const out_instance)
{
...
/// Contains the maximum number of bytes needed to serialize a(n) uavcan_si_sample_voltage_Scalar_1_0
/// instance.
#define uavcan_si_sample_voltage_Scalar_1_0_MAX_SERIALIZED_REPRESENTATION_SIZE_BYTES \
        (11U)


/// Serialization of uavcan_si_sample_voltage_Scalar_1_0 instance into a byte array.
///
...
static inline NunavutSignedBitLength uavcan_si_sample_voltage_Scalar_1_0_serialize(const uavcan_si_sample_voltage_Scalar_1_0* in_instance, NunavutUnsignedBitLength offset, uint8_t* const out_buffer)
{
...
/// Deserialization of byte-array encoding into uavcan_si_sample_voltage_Scalar_1_0 instance.
///
...
static inline NunavutSignedBitLength uavcan_si_sample_voltage_Scalar_1_0_deserialize(uavcan_si_sample_voltage_Scalar_1_0* const out_instance, NunavutUnsignedBitLength offset, uint8_t* const in_buffer, const size_t buf_size_bytes)
{
    NunavutSignedBitLength rc = 0;
