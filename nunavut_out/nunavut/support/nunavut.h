...
static inline NunavutUnsignedBitLength nunavutInternalGetBitCopySize(const size_t buf_size_bytes,
                                   ...
                                   const uint8_t* const src, uint8_t* const dst)
{
    ...
    NUNAVUT_ASSERT((src < dst) ? ((src + ((src_offset_bit + length_bit + NUNAVUT_BYTE_WIDTH) / NUNAVUT_BYTE_WIDTH)) <= dst)
    ...
    else
    {
        ...
        while (last_bit > src_off)
        {
            ...
            const uint8_t in =
                (uint8_t)((uint8_t)(src[src_off / NUNAVUT_BYTE_WIDTH] >> src_mod) << dst_mod) & NUNAVUT_BYTE_MAX;  // NOSONAR
...
static inline void nunavutSetIxx(uint8_t* const buf, const NunavutUnsignedBitLength off_bit, const int64_t value,
                                 const uint8_t len_bit)
{
...
static inline uint8_t nunavutGetU8(const uint8_t* const buf, const size_t buf_size,
                                   const NunavutUnsignedBitLength off_bit, const uint8_t len_bit);

static inline bool nunavutGetBit(const uint8_t* const buf, const size_t buf_size,
...
{
    NUNAVUT_ASSERT(buf != NULL);
    const NunavutUnsignedBitLength copy_size = nunavutInternalGetBitCopySize(buf_size, off_bit, len_bit, NUNAVUT_BYTE_WIDTH);
...
static inline uint16_t nunavutGetU16(const uint8_t* const buf, const size_t buf_size,
                                     const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
    NUNAVUT_ASSERT(buf != NULL);
    const NunavutUnsignedBitLength copy_size = nunavutInternalGetBitCopySize(buf_size, off_bit, len_bit, NUNAVUT_WIDTH16);
...
static inline uint32_t nunavutGetU32(const uint8_t* const buf, const size_t buf_size,
                                     const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
    NUNAVUT_ASSERT(buf != NULL);
    const NunavutUnsignedBitLength copy_size = nunavutInternalGetBitCopySize(buf_size, off_bit, len_bit, NUNAVUT_WIDTH32);
...
static inline uint64_t nunavutGetU64(const uint8_t* const buf, const size_t buf_size,
                                     const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
    NUNAVUT_ASSERT(buf != NULL);
    const NunavutUnsignedBitLength copy_size = nunavutInternalGetBitCopySize(buf_size, off_bit, len_bit, NUNAVUT_WIDTH64);
...
static inline int8_t nunavutGetI8(const uint8_t* const buf, const size_t buf_size,
                                  const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
...
static inline int16_t nunavutGetI16(const uint8_t* const buf, const size_t buf_size,
                                    const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
...
static inline int32_t nunavutGetI32(const uint8_t* const buf, const size_t buf_size,
                                    const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
...
static inline int64_t nunavutGetI64(const uint8_t* const buf, const size_t buf_size,
                                    const NunavutUnsignedBitLength off_bit, const uint8_t len_bit)
{
...
static inline NunavutFloat32 nunavutGetF16(const uint8_t* const buf, const size_t buf_size,
                                           const NunavutUnsignedBitLength off_bit)
{
...
static inline NunavutFloat32 nunavutGetF32(const uint8_t* const buf, const size_t buf_size,
                                           const NunavutUnsignedBitLength off_bit)
{
...
static inline NunavutFloat64 nunavutGetF64(const uint8_t* const buf, const size_t buf_size,
                                           const NunavutUnsignedBitLength off_bit)
{
    // Intentional violation of MISRA: use union to perform fast conversion to an IEEE 754-compatible native
    // representation into a serializable integer. The assumptions about the target platform properties are made
